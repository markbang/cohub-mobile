...
- When `NATIVE_AUTO_RELEASE_ENABLED=true`, a created release builds an arm64 Android debug APK and attaches it to the GitHub Release; iOS and store uploads remain manual. EAS is not required.
