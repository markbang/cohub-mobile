...
const styles = StyleSheet.create({
  ...
  composerWrap: { paddingHorizontal: 12, paddingTop: 9, paddingBottom: 10, borderTopWidth: 1 },
  composer: { minHeight: 88, borderWidth: 1, borderRadius: 18, paddingHorizontal: 9, paddingTop: 9, paddingBottom: 6, gap: 2 },
