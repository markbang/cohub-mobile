...
export default function SpaceScreen() {
  ...
  if (!space) {
    return <Screen><DetailTopBar title={t("space.title")} onBack={() => router.back()} /><View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}><Text style={[typography.body, { color: theme.colors.textMuted }]}>{spaceLoading ? t("space.opening") : t("space.unavailable")}</Text></View></Screen>;
  }
  ...
  return <Screen>
    ...
    <View style={{ flexDirection: "row", paddingHorizontal: 16, gap: 10 }}>
      <SpaceMetric icon="messages" label={t("space.metric.chats")} value={String(sessions.length)} />
