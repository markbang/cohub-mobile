...
function SendBubbleMotion({ transition, message, spaceId, availableWidth, onCopy, bubbleRef, onBubbleLayout }: { transition: { sourceX: number; sourceY: number; targetX: number; targetY: number; targetHeight: number }; message: MessageRecord; spaceId?: string; availableWidth?: number; onCopy: (text: string) => void; bubbleRef: React.RefObject<View | null>; onBubbleLayout: () => void }) {
  ...
  return <MessageBubble message={message} local onCopy={onCopy} spaceId={spaceId} availableWidth={availableWidth} bubbleRef={bubbleRef} onBubbleLayout={onBubbleLayout} animatedStyle={style} />;
}
