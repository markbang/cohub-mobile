...
function SendBubbleMotion({ transition, message, spaceId, onCopy, bubbleRef, onBubbleLayout }: { transition: { sourceX: number; sourceY: number; targetX: number; targetY: number; targetHeight: number }; message: MessageRecord; spaceId?: string; onCopy: (text: string) => void; bubbleRef: React.RefObject<View | null>; onBubbleLayout?: () => void }) {
